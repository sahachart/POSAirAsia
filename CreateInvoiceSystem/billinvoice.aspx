<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="billinvoice.aspx.cs" Inherits="CreateInvoiceSystem.billinvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="searchCriteria">
        ...
        <tr>
            ...
            <td class="tableform" style="width: 35%; text-align: left">
                <asp:RadioButtonList ID="rbl_typ_receipt" runat="server" RepeatDirection="Horizontal">
        ...
        <tr>
            <td class="tableform" style="width: 141px">Branch<span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="width: 35%; text-align: left" colspan="1">
                <asp:DropDownList ID="ddl_station" runat="server" Width="150px"></asp:DropDownList>&nbsp;&nbsp; 
                Slip Message :&nbsp;<asp:DropDownList ID="ddl_slip" runat="server" Width="120px"></asp:DropDownList>

            </td>
            <td class="tableform Route" style="width: 115px">Route</td>
            <td class="tableform Route" style="text-align: left; width: 58px;">
                <asp:DropDownList ID="ddl_Route" runat="server" ClientIDMode="Static">
                    <asp:ListItem Selected="True" Value="AA">AK</asp:ListItem>
                    <asp:ListItem Value="TAA">QZ</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td class="tableform" style="width: 90px"></td>
            <td class="tableform" style="text-align: left"></td>
        ...
        <tr>
            ...
            <td class="tableform" rowspan="4">
                <asp:TextBox ID="txt_SlipHeader" runat="server" ClientIDMode="Static" TextMode="MultiLine" Width="420px" Height="108px"></asp:TextBox>
            </td>
            <%--</tr>
        <tr>
            <td class="tableform" style="height: 27px;" colspan="2">Branch Name</td>
            <td class="tableform" style="text-align: left; height: 27px;">
        ...
        <tr>
            <td class="tableform" style=""><%--Address1--%></td>
        ...
        <tr>
            <td class="tableform" style="" colspan="2"><%--Address2--%></td>
            <%--<td class="tableform" style=" text-align: left">
        ...
        <tr>
            <td class="tableform" style="" colspan="2"><%--Address3--%></td>
            <%--<td class="tableform" style=" text-align: left">
        ...
        <tr>
            <td class="tableform" style="width: 141px">Tax ID <span style="color: red">&nbsp;*</span></td>
        ...
        <tr>
            <td class="tableform" style="width: 141px">Booking Name <span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="width: 349px; text-align: left">
                <asp:TextBox ID="tbx_booking_name" runat="server"></asp:TextBox>
            </td>
            ...
            <td class="tableform" style="width: 100px">Receipt Date <span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="text-align: left">
                <asp:TextBox ID="tbx_date_receipt" runat="server" Width="120px"></asp:TextBox>
            </td>
            <td style="width: 30px;">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td class="tableform" style="width: 349px; text-align: left">
                <asp:TextBox ID="tbx_booking_address1" runat="server" MaxLength="255" Width="100%"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 115px">Booking No. <span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="text-align: left; width: 58px;">
                <asp:TextBox ID="tbx_booking_no" runat="server"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 105px">Booking Date <span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="text-align: left">
                <asp:TextBox ID="tbx_date_booking" runat="server" Width="120px"></asp:TextBox>
            </td>
            <td style="width: 30px;">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td class="tableform" style="width: 349px; text-align: left">
                <asp:TextBox ID="tbx_booking_address2" runat="server" MaxLength="255" Width="100%"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 115px">Route</td>
            <td class="tableform" style="text-align: left;" colspan="3" rowspan="2">
                <asp:TextBox ID="tbx_route" runat="server" Width="100%" Rows="2" TextMode="MultiLine"></asp:TextBox>
            </td>
            <td style="width: 30px;">&nbsp;</td>
        </tr>
        <tr>
            ...
            <td class="tableform" style="width: 349px; text-align: left">
                <asp:TextBox ID="tbx_booking_address3" runat="server" MaxLength="255" Width="100%"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 115px">&nbsp;</td>
        </tr>
        <tr>
            <td class="tableform" style="width: 141px">Tax ID<span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="width: 349px; text-align: left">
                <asp:TextBox ID="tbx_booking_taxid" runat="server" MaxLength="13"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 115px">Remark</td>
            <td class="tableform" style="text-align: left" colspan="3" rowspan="2">
                <asp:TextBox ID="tbx_remark" runat="server" Width="100%" Rows="2" TextMode="MultiLine"></asp:TextBox>
            </td>
            <td style="width: 30px;"></td>
        </tr>
        <tr>
            <td class="tableform" style="width: 141px;">Passenger Name<span style="color: red">&nbsp;*</span></td>
            <td class="tableform" style="width: 349px; text-align: left; height: 24px;" rowspan="2">
                <asp:TextBox ID="tbx_passenger_1" runat="server" Width="100%" Rows="2" TextMode="MultiLine"></asp:TextBox>
            </td>
            <td class="tableform" style="width: 115px;">&nbsp;</td>
            <td class="tableform" style="text-align: left;">&nbsp;</td>
        </tr>
        ...
        <tbody>
            <tr>
                <td class="headlabel" colspan="7">Payment Information<span style="color: red">&nbsp;*</span></td>
            </tr>
            <tr>
                <td colspan="7">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="" style="width: 102px; text-align: left;"></td>
                            <td class="tableform" style="width: 110px">&nbsp;</td>
                            <td class="tableform" style="text-align: left; width: 316px"></td>
                    ...
                    <table id="tb_detail" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 620px">Description</th>
                        ...
                        <tfoot>
                            <tr>
                                <td class="text-right" colspan="6" style="font-weight: bold">Total</td>
                            ...
                            <tr>
                                <td class="text-right" colspan="6" style="font-weight: bold">VAT&nbsp;<asp:DropDownList runat="server" ID="ddl_vat"></asp:DropDownList><span style="color: red">&nbsp;*</span></td>
                                <td class="text-right" style="font-weight: bold">
                            ...
                            <tr>
                                <td class="text-right" colspan="6" style="font-weight: bold">Grand Total</td>
                                <td class="text-right" style="font-weight: bold">
                ...
                <td colspan="7">
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td>&nbsp;<asp:TextBox ID="tbx_card_no" runat="server" Width="200px" MaxLength="16"></asp:TextBox>
                            </td>
                            <td>&nbsp;Bank&nbsp;
                            </td>
                            <td>
    ...
    <div class="row">
        <div style="text-align: center">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button runat="server" ID="Button_print" OnClientClick="return false;" Text="Print" Height="40px" Width="80px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
    <div id="dialog-data">
                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="form-group">
                        <div class="col-sm-12" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddl_patment_type" runat="server" Width="180px" CssClass="txtControl"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox TextMode="MultiLine" Columns="40" Rows="3" ID="tbx_desc" runat="server" CssClass="txtControl"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="tbx_qty" runat="server" CssClass="txtControl"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="tbx_unit" runat="server" CssClass="txtControl"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            DataDetail = function (obj) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    var item = "<tr>" + colButton + colIndex + colName + colQty + colUnit + colAmt + "</tr>";
            ...
            getDataRow = function (index) {
                ...
                var desc = cells[3].innerHTML;
                var qty = cells[4].innerHTML.replace(",", "");
                var price = cells[5].innerHTML.replace(",", "");
                var amount = cells[6].innerHTML.replace(",", "");
            ...
            updaterow = function () {
                ...
                cells[3].innerHTML = $("#MainContent_tbx_desc").val();
                cells[4].innerHTML = $("#MainContent_tbx_qty").val();
                cells[5].innerHTML = format_amount(parseFloat(unit).toLocaleString());
                cells[6].innerHTML = res_amtfm;
                update_rowindex();
                return true;
            };
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < dt.length; i++) {
                            header += dt[i].Descriptions + "\n";
                        }

                        $('#txt_SlipHeader').val(header.slice(0, -1));
                        //if (dt.length > 0) {
                        //    var comp
                ...
                if (valid) {
                    ...
                    try {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            cache: false,
                            data: JSON.stringify({ oinfo: info, olist: list, mode: mode, route: Route }),
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (data) {
            ...
            initial_mode = function () {
                ...
                if (mode == 'add') {
                    ...
                    disable_control('MainContent_Save', true);
                    disable_control('MainContent_Button1', true);
            ...
            $('#MainContent_Button1').click(function () {
                //history.back();
                window.location.href = 'billinvoicelist.aspx';
