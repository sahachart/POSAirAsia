<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FlightType.aspx.cs" Inherits="CreateInvoiceSystem.FlightType" %>
<asp:Content ID="Content1" ContentPlaceHolderID="FeaturedContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            <table class="searchCriteria">
        <tr>
            <td class="headlabel" colspan="5" >Flight Type Master</td>
        </tr>
        <tr>
            <td class="searchCriterialabel" nowrap >Flight Type Code</td>
            <td style="width: 30%" ><asp:TextBox ID="tcode" runat="server" CssClass="txtFormCell"></asp:TextBox></td>
            <td class="searchCriterialabel" nowrap>Flight Type Name</td>
    ...
    <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" ShowHeaderWhenEmpty="True" DataKeyNames="Flight_Type_Id" 
                            ...
                            EnablePersistedSelection="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20">
                                ...
                                <asp:BoundField HeaderText="Flight Type Code" DataField="Flight_Type_Code" HeaderStyle-Width="200px" />
                                <asp:TemplateField HeaderText="Flight Type Name">   
                                    <ItemTemplate>
                                        <a href="javascript:editmode('<%# Eval("Flight_Type_Id") %>');"><%# Eval("Flight_Type_Name") %></a>       
                                    </ItemTemplate>
    ...
    <div id="dialog-confirm" title="Create Flight Type">
        <table style="width: 100%">
            <tr>
                <td style="text-align: right; padding-right: 10px; width: 40%;" nowrap>Flight Type Code<span style="color:red ">*</span></td>
                <td style="width: 60%"><asp:TextBox ID="code" runat="server" Width="200px" CssClass="txtcalendar" MaxLength="50"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="text-align: right; padding-right: 10px; width: 40%;" nowrap>Flight Type Name<span style="color:red ">*</span></td>
                ...
                $("#dialog-confirm").dialog({
                    ...
                    buttons: {
                        "Save": function () {
                            ...
                            var msg = '';
                            $.ajax({
                                url: 'servicepos.asmx/SaveFlightType',
                                type: "POST",
                                dataType: "xml",
                                cache: false,
